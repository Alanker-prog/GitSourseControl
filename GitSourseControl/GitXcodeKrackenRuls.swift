...
/*
 ...
 ✅ После слияния можно удалить дополнительную ветку, жмем правой кнопкой мыши на доп ветку и жмем Delete.. и Delete, но в Kracken и Git она будет отображаться, что бы ее удалить заходит на Git -> преходим во вкладку Branches и жмем на корзину удаления у доп ветки
 */
